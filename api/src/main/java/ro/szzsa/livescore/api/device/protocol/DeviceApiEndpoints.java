...
public final class DeviceApiEndpoints {
   ...
   */
  public static final String GET_STATS_URL = DEVICE_API_V1_ROOT_PATH + GET_STATS_PATH;
   ...
   */
  public static final String GET_GAME_DETAILS_URL = DEVICE_API_V1_ROOT_PATH + GET_GAME_DETAILS_PATH;
