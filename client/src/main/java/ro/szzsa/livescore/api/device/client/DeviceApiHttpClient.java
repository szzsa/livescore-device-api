...
import ro.szzsa.livescore.api.device.client.connector.Connector;
import ro.szzsa.livescore.api.device.client.connector.Connectors;
import ro.szzsa.livescore.api.device.client.connector.Request;
